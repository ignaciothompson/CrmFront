  ...
  { path: 'comparacion/:id', loadComponent: () => import('./features/comparativas/pages/comparativa-detail/comparativa-detail').then(m => m.ComparativaDetailPage) },
	{
		...
		children: [
            ...
            { path: 'ventas', data: { title: 'Ventas' }, loadComponent: () => import('./features/ventas/ventas-list/ventas').then(m => m.VentasPage) },
			...
			{ path: 'entrevistas', data: { title: 'Entrevistas' }, loadComponent: () => import('./features/entrevistas/entrevistas-list/entrevistas').then(m => m.Entrevistas) },
